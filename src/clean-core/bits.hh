...
constexpr bool is_pow2(unsigned char v) { return (v & (v - (unsigned char)(1))) == 0; }
constexpr bool is_pow2(unsigned short v) { return (v & (v - (unsigned short)(1))) == 0; }
constexpr bool is_pow2(unsigned int v) { return (v & (v - (unsigned int)(1))) == 0; }
constexpr bool is_pow2(unsigned long v) { return (v & (v - (unsigned long)(1))) == 0; }
constexpr bool is_pow2(unsigned long long v) { return (v & (v - (unsigned long long)(1))) == 0; }
