...
inline int popcount(uint8 v) { return __popcnt16(v); }
inline int popcount(uint16 v) { return __popcnt16(v); }
inline int popcount(uint32 v) { return __popcnt(v); }
inline int popcount(uint64 v) { return __popcnt64(v); }
...
inline int count_leading_zeros(uint8 v) { return __lzcnt16(v) - 8; }
inline int count_leading_zeros(uint16 v) { return __lzcnt16(v); }
inline int count_leading_zeros(uint32 v) { return __lzcnt(v); }
inline int count_leading_zeros(uint64 v) { return __lzcnt64(v); }
