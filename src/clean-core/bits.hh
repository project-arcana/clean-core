...
inline uint32_t ceil_pow2(uint32_t v) { return uint32_t(1) << (31 & (bit_log2(v - uint32_t(1)) + 1)); }
inline uint64_t ceil_pow2(uint64_t v) { return uint64_t(1) << (63 & (bit_log2(v - uint64_t(1)) + 1)); }
